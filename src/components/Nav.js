...
const Nav = () => {
    return <Stack /*borderBottom={'1px solid #e6e6e6'}*/ >
        ...
        <Stack padding={'0 270px 0 '} >
            <Stack width={'100%'} direction={'row'} justifyContent={'space-between'} alignItems={'center'}>
                <Stack >
                    <Typography fontSize={'50px'} color={'#723f5fe6'} fontFamily={'Bitter,Georgia,Cambria,Times New Roman,Times,serif'}>pinch <Typography display={'inline'} fontSize={'30px'} color="#723f5f40">of</Typography> yum</Typography>
                </Stack>
